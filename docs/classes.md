...
There are two base classes: **Warrior** or **Spellcaster**. The [feats](feats.md) that you choose at first level and at each later level will significantly customize your class.
