...
| **Rage** | You can expend a HD to rage as a minor action or as a triggered action when you take damage. Roll the HD and gain that many temp HP (Min: CON). Your rage lasts until the end of the scene, you fall unconscious, or spend a minor action to end it. While raging, you have advantage on melee attacks and on STR and CHA saves, but enemies have advantage on attack rolls against you. You cannot concentrate or cast spells while raging. You lose any temp HP at the end of your rage. | **Level 1** |
