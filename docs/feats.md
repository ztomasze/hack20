...
Feats are come in one of three types:

* general feat - Available to any class
* talent - feats available only to warriors
* knacks - feats available only spellcasters

**Prereq:** Feats marked as "Level 1" can only be taken at first level.
