...
These are optional rules that you can use at your table. They tend to add complexity to the core rules, so you can choose to ignore them.  If you do add one, you might add it always or only for a given campaign.
